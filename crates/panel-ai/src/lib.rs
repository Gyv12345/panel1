...
pub use agents::{AdvisorAgent, AgentResponse, InstallMode, InstallerAgent, UrlInstallReport};
...
pub mod prelude {
    pub use crate::agents::{
        AdvisorAgent, AgentResponse, InstallMode, InstallerAgent, UrlInstallReport,
    };
